...
function Contact() {
  return (
    <section>
      <div>
        <Frame  frameImg={contactFrame} />
      </div>
      <div className="wrapper">
        <div className="container mt-[76px]">
          <div className="flex items-center justify-center">
            <h2 className=" text-center heading xl:text-[50px] md:text-[40px] text-[30px] font-normal tracking-[1.2px] text-black max-w-[683px]">
              We love meeting new people and helping them.
            </h2>
          </div>
          <div className="flex lg:mt-[96px] mt-[40px] justify-between xl:gap-[153px] gap-[50px] md:flex-row flex-col">
          <div 
            className="flex items-start justify-start flex-col lg:gap-[30px] gap-[15px]  md:max-w-[260px]"
              > 
                <div className="flex gap-[15px] items-center">
                  <div className="lg:w-[52px] lg:h-[52px]  w-[30px] h-[30px]">
                     <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 52 52" fill="none">
                       <circle cx="26" cy="26" r="26" fill="white"/>
                       <path d="M18 20.9999L26 27.9999L34 20.9999M17.1154 17.9999H34.8846C36.0529 17.9999 37 18.9513 37 20.1249V32.8749C37 34.0485 36.0529 34.9999 34.8846 34.9999H17.1154C15.9471 34.9999 15 34.0485 15 32.8749V20.1249C15 18.9513 15.9471 17.9999 17.1154 17.9999Z" stroke="#CDA274" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                     </svg>
                  </div>
                  <p className="paragraph lg:text-[20px] text-[15px] text-richBlack font-normal">info@selhono.com</p>
                </div>
                <div className="flex gap-[15px] items-center">
                  <div className="lg:w-[52px] lg:h-[52px]  w-[30px] h-[30px]">
                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 52 52" fill="none">
                  ...
                  <p className="paragraph lg:text-[20px] text-[15px] text-richBlack font-normal">+1 (378) 400-1234</p>
                </div>
                <div className="flex gap-[15px] items-center">
                    <div className="lg:w-[52px] lg:h-[52px]  w-[30px] h-[30px]">
                        <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 52 52" fill="none">
                  ...
                  <p 
                  className="paragraph lg:text-[20px] text-[15px] text-richBlack font-normal"
                  >
                    www.selhono.com</p>
                </div>
                <div 
                  className="flex md:gap-[35px] gap-[20px] lg:mt-[55px] mt-[20px] md:text-[18px] text-[15px] cursor-pointer ml-2"
                >
                   <FaFacebookF />
                   <FaTwitter />
                   <FaLinkedinIn />
              ...
              <div className="xl:max-w-[797px] md:max-w-[500px] flex flex-col gap-[50px]">
              <div className="flex gap-[39px] justify-between sm:flex-row flex-col">
                <div className=" flex flex-col  md:w-[472px] sm:w-[200px] w-full relative">
                  <input
                    type="text"
                    placeholder="Name"
                    className="w-full  outline-none paragraph  md:text-[22px] text-[18px] text-richBlack select-none h-[43px]"
                  />
                  <div className="absolute lg:bottom-[-13px] sm:bottom-[-4px] bottom-2 left-0 w-full h-[1px] bg-black"></div>
                </div>
              ...
              <div className="relative flex flex-col w-full ">
                <input
                  ...
                  className="w-full  outline-none paragraph md:text-[22px] text-[18px] text-richBlack select-none h-[43px]"
                />
                <div className="absolute lg:bottom-[-130px] sm:bottom-[-4px] bottom-2 left-0 w-full h-[1px] bg-black"></div>
              </div>
              <div className="flex   justify-center md:justify-end lg:mt-[200px] md:mt-[100px] mt-[20px]">
                 <CTABtn
                   active={false}
                   children={"Send Now"}
                   style={
      ...
      <div className="md:mt-[119px] mt-[50px]">
         <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d448193.95107683446!2d76.76355055191493!3d28.644287342601416!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfd5b347eb62d%3A0x37205b715389640!2sDelhi!5e0!3m2!1sen!2sin!4v1705319033886!5m2!1sen!2sin"     className="w-[100%] md:min-h-[500px] h-[300px]"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
      <div className="md:mt-[207px] mt-[100px]">
        <Footer />
      </div>
    </section>
  );
