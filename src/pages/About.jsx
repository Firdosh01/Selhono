...
import frameImg from "../assets/About/Rectangle 11.png";
        ...
        <div className="wrapper">
          <div className="container">
            <div className="frame_text lg:mt-[188px] mt-[70px]">
              <h1 className="heading lg:text-[70px] sm:text-[50px] text-[30px]  text-white drop-shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
                About Us
              </h1>
            </div>
              ...
              <div className="mt-[98px]">
                <div className="flex md:gap-[265px] justify-between sm:flex-row flex-col">
                  <div className=" flex flex-col  md:w-[472px] sm:w-[200px] w-full relative">
                    <input type="text" placeholder="Name" className="w-full  outline-none paragraph xl:text-[30px] md:text-[20px] text-[15px] text-richBlack select-none h-[43px]" />
                  ...
                  <div className=" flex flex-col  md:w-[472px] sm:w-[200px] w-full relative sm:mt-0 mt-[20px]">
                    <input type="text" placeholder="Email" className="w-full  outline-none paragraph xl:text-[30px] md:text-[20px] text-[15px] text-richBlack select-none h-[43px]" />
                    <div className="absolute lg:bottom-[-11px] sm:bottom-[-4px] bottom-2 left-0 w-full h-[1px] bg-black"></div>
                  </div>
                </div>
                <div className=" flex flex-col w-full relative lg:mt-[235px] sm:mt-[100px] mt-[20px]">
                    <input type="text" placeholder="Message" className="w-full  outline-none paragraph xl:text-[30px] md:text-[20px] text-[15px] text-richBlack select-none h-[43px]" />
                    <div className="absolute lg:bottom-[-11px] sm:bottom-[-4px] bottom-2 left-0 w-full h-[1px] bg-black"></div>
                </div>
              </div>
