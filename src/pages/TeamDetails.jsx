    ...
    <section>
      ...
      <div className="wrapper">
        <div className="container">
          <div className="flex items-start md:flex-row  flex-col-reverse justify-between md:mt-[112px] mt-[50px]">
            <div>
              <div  className="flex flex-col items-center justify-center">
              <h2 className="lg:text-[50px] md:text-[40px] text-[30px] font-DMSerif font-normal leading-[150%] tracking-[0.25px] text-black">
                {user.name}
              </h2>
              <span className="font-Jost lg:text-[22px] md:text-[20px] text-[15px] text-center font-normal leading-[150%] tracking-[0.18px] text-richBlack">
                 Designer
              </span>
              </div>
              <div className="max-w-[552px] mt-[52px]">
                <p className="font-normal paragraph tracking-[0.22px] text-richBlack lg:text-[22px] md:text-[20px] text-[15px] ">Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere in.Contrpobelie frandomised words which don't look even slightly believable.</p>
              </div>
              <div 
                className="flex items-start justify-start flex-col lg:gap-[30px] gap-[15px] lg:mt-[52px] mt-[20px] mr-0"
              > 
            ...
            <div 
              className="xl:w-[605px] xl:h-[705px] lg:w-[400px] lg:h-[600px]  md:w-[300px]  h-[400px]   flex justify-center items-center text-center w-full"
             >
              <img 
               src={user.img}
               alt={user.name} 
